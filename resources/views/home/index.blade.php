	...
	<div class="header-w3ls-agileinfo ">
			...
			<div class="wthree_agile_top_header">
				<div class="logo-agileits">
					<h1><a href="/home"><span>K</span>nowledge Sea <i class="fa fa-graduation-cap" aria-hidden="true"></i></a></h1>
				</div>
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="#team" class="hvr-rectangle-out scroll">Our Team</a></li>
																...
																<div class="modal-header">
																	...
																	<h3 class="agileinfo_sign">SIGN IN</h3>	
																			<div class="login-form">
																				...
																				{{method_field('PUT')}}
																					<input type="email" name="signin_email" placeholder="E-mail" required="">
																	...
																	<h3 class="agileinfo_sign">Sign Up</h3>	
																			<div class="login-form">
																				<form
																				 ...
																				 {{csrf_field()}}
																				   <input type="text" name="signup_name" placeholder="Username" required="">
																					<input type="email" name="signup_email" placeholder="Email" required="">
																					<input type="password" name="signup_password" placeholder="Password" required="">
																					<input type="password" name="signup_re_password" placeholder="Confirm Password" required="">
...
<!-- banner -->	
	<div class="w3ls_banner_section">
		<div class="container">
			<h2>Ask Your Question And Find <span>Solution</span></h2>
			<p> Out boot camp comming soon</p>
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
					       <h3 class="agileinfo_sign">Knowledge Sea</h3>	
						<img src="images/ab.jpg" alt=" " class="img-responsive" />
						<p>This our first Boot camp.We will first teach you how to use our website.Then we will teach how to ask ask question and how to give answer of questions.
							<i>" So please every one join our camp and learn more  .</i></p>
					</div>
				</section>
			</div>
		</div>
...
<!-- banner-bottom -->
	<div class="banner-bottom-agileits" id="about">
			...
			<div class="col-md-7 w3l_banner_bottom_left">
				<h3>Get any kinds of answer from our site</h3>
				<p>This is a E-Learning website.You all post your questions and others will answer your question.By this way user build up his/her profile .
					<span>This way we will provide users a rank list .Some companies who will offer it jobs for users.</span></p>
			</div>
			<div class="clearfix"></div>
	</div>
<!-- //banner-bottom -->
	...
	<div class="services" id="services">
		...
		<div class="w3ls-heading">
				<h3 class="h-two">Objectives</h3>
				<p class="sub two">See our features.</p>
			</div>
			<div class="w3layouts-grids">
				<div class="services-right-grids">
					<div class="col-sm-4 services-right-grid">
						...
						<div class="services-icon-info">
							<h5>Skills</h5>
							<p>By questinning and answering you can develop your skill.</p>
						</div>
					</div>
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
						...
						<div class="services-icon-info">
							<h5>Self Learning</h5>
							<p>Self learnning is a great things.You get it from here.</p>
						</div>
					</div>
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
						...
						<div class="services-icon-info">
							<h5>Knowledge</h5>
							<p>Knowkedge increasing is a great thing.Geather knowledge from here.</p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="services-right-grids">
					<div class="col-sm-4 services-right-grid">
						...
						<div class="services-icon-info">
							<h5>Discussion</h5>
							<p>Discussion is a good thing for earn knowledge .Do it here.</p>
						</div>
					</div>
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
						...
						<div class="services-icon-info">
							<h5>Earn Money</h5>
							<p>Many online company offer you job in here .Try to get it.</p>
						</div>
					</div>
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
						...
						<div class="services-icon-info">
							...
							<p>We provide you all fecelities here .Just take it and do well in life .</p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
...
<!-- team -->
	<div class="team" id="team">
		<div class="container">
			<div class="w3ls-heading">
				<h3>Team Knowledge Sea</h3>
				<p class="sub">We always trying to improve our Services.</p>
			</div>
			<div class="w3layouts-grids">
					...
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="images/nayem.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
...
<div class="w3ls-heading">
				<h3>Latest News</h3>
				<p class="sub">We are going to arrange a confarance</p>
			</div>
			<div class="w3layouts-grids">
<div class="col-md-6 news-agileits-right news2">
		<i>30th November 2017</i>
		<p>Mj Nayem,CEO of Knowledge Sea comming live and teach you many things .So stay with us</p>
		<img src="images/nayem.jpg" alt="image"><h6>Mj Nayem</h6>
	</div>
	...
	<div class="col-md-6 news-agileits-right">
		<i>5th December 2017</i>
		<p>Mj Nayem,CEO of our company comming live to take another learning seassion .So Stay with us.</p>
		<img src="images/nayem.jpg" alt="image"><h6>Mj Nayem</h6>
	</div>
	<div class="clearfix"></div>
	</div>
...
<!-- gallery -->
	<div class="gallery" id="gallery">
	 <div class="w3ls-heading">
				<h3>Our Gallery</h3>
				<p class="sub">Here is some Photo of our Activities </p>
			</div>
			...
			<div class="gallery-grids-row">
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g1.jpg" class="jzBoxLink item-hover" title="Education">  
		...
		<div class="container">
			...
			<div class="w3layouts-grids">
				<div class="col-md-4 contact-left">
					...
					<div class="contact-info">
						...
						<div class="contact-info-right">
							<h5>Mobile</h5>
							<ul>
								<li>+880 1720209319</li>
								<li>+880 1672690529</li>
							</ul>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="contact-info">
						...
						<div class="contact-info-right">
							<h5>E-Mail</h5>
							<ul>
								<li><a href="#">knowledgesea@gmail.com</a></li>
								<li><a href="#">mjnayem@gmail.com</a></li>
							</ul>
						</div>
						<div class="clearfix"> </div>
					</div>
				...
				<div class="col-md-8 contact-form">
					<form action="/complain/0" method="post">
					{{csrf_field()}}
					{{method_field("PUT")}}
						
				
						<input type="text" class="phone" name="email" placeholder="Email" required="">
		...
		<div class="footer-main">
			<div class="footer-top">
				<div class="col-md-4 ftr-grid fg1">
					<h3><a href="index.html"><span>K</span>nowledge Sea</a></h3>
					<p>Earn knowkedge from here.Ask any kinds qustion you must get answer.Develop your skill by answering question.</p>
				</div>
				<div class="col-md-4 ftr-grid fg2 mid-gd">
					...
					<div class="ftr-address">
						...
						<div class="ftr-text">
							<p>Jamil Tower,12/Link Road,Dhaka</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="ftr-address">
					...
					<div class="ftr-address">
						...
						<div class="ftr-text">
							<p><a href="mailto:info@example.com">knowkedgesea@gmail.com</a></p>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
